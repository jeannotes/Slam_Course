...
public:
    OpticalFlowTracker(const Mat &img1_,
                       ...
                       bool inverse_ = true,
                       bool has_initial_ = false) : img1(img1_), img2(img2_), kp1(kp1_), kp2(kp2_),
                                                    success(success_), inverse(inverse_),
...
int main(int argc, char **argv)
{
    ...
    cv::imwrite("../single_level.jpg", img2_single);
    cv::imshow("tracked multi level", img2_multi);
    cv::imwrite("../multi_level.jpg", img2_multi);
    // cv::imshow("tracked by opencv", img2_CV);
    cv::imwrite("../opencv_method.jpg", img2_CV);
    cv::waitKey(0);
