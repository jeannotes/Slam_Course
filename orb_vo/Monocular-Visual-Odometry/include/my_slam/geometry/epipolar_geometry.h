...
void filterHomographyDecompByVisibleRefpoints(cv::InputArrayOfArrays rotations,
                                              cv::InputArrayOfArrays normals,
                                              cv::InputArray beforePoints,
                                              cv::InputArray afterPoints,
                                              cv::OutputArray possibleSolutions,
                                              cv::InputArray pointsMask = cv::noArray());
