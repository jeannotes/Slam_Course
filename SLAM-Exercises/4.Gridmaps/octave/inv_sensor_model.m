...
for sc=1:columns(laserEndPntsMapFrame)
        ...
        %[robPoseMapFrame(1), robPoseMapFrame(2); laserEndPntsMapFrame(1,sc), laserEndPntsMapFrame(2,sc)]
        %[X, Y] = bresenham([robPoseMapFrame(1), robPoseMapFrame(2); laserEndPntsMapFrame(1,sc), laserEndPntsMapFrame(2,sc)]);
        [X, Y] = bresenham([robPoseMapFrame(1:2)'; laserEndPntsMapFrame(:,sc)']);
